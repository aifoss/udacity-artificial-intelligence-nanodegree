...
class PlanningGraph():
    ...
    """ Helper method used by inconsistent_effects_mutex() and interference_mutex() """
    def _check_expr_inclusion(self, expr_list_1, expr_list_2):
        for expr in expr_list_1:
            if expr in expr_list_2:
                return True
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        if self._check_expr_inclusion(node_a1.action.effect_add, node_a2.action.effect_rem) == True:
            return True
        if self._check_expr_inclusion(node_a2.action.effect_add, node_a1.action.effect_rem) == True:
            return True
        if self._check_expr_inclusion(node_a1.action.effect_rem, node_a2.action.effect_add) == True:
            return True
        if self._check_expr_inclusion(node_a2.action.effect_rem, node_a1.action.effect_add) == True:
            return True
        return False
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        if self._check_expr_inclusion(node_a1.action.effect_add, node_a2.action.precond_neg) == True:
            return True
        if self._check_expr_inclusion(node_a2.action.effect_add, node_a1.action.precond_neg) == True:
            return True
        if self._check_expr_inclusion(node_a1.action.effect_rem, node_a2.action.precond_pos) == True:
            return True
        if self._check_expr_inclusion(node_a2.action.effect_rem, node_a1.action.precond_pos) == True:
            return True
        return False
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        return (node_s1.symbol == node_s2.symbol and 
                ((node_s1.is_pos and not node_s2.is_pos) or
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
            for level_idx, level_states in enumerate(self.s_levels):
                goal_state = PgNode_s(goal, True)
                if goal_state in level_states:
                    level_cost_sum += level_idx
                    break
        return level_cost_sum
